...
import { useTitleAnimation, useIntersectionAnimation } from '@/hooks/useAnimations';
...
export default function Hero() {
  ...
  const { registerElement, startAnimation } = useIntersectionAnimation(SUBTITLE_ANIMATION_OPTIONS);
